...
# api/serializers.py - Update the ProductSerializer

class ProductSerializer(serializers.ModelSerializer):
    farmer_name = serializers.SerializerMethodField()
    farmer_phone = serializers.SerializerMethodField()  # Add this
...
# api/serializers.py - Update the OrderSerializer

class OrderSerializer(serializers.ModelSerializer):
    items = OrderItemSerializer(many=True, read_only=True)
    buyer_name = serializers.SerializerMethodField()
    buyer_phone = serializers.SerializerMethodField()  # Add this
    buyer_contact_phone = serializers.SerializerMethodField()  # Add this for order-specific contact
    ...
    def get_buyer_contact_phone(self, obj):
        # Return the contact phone for this specific order
