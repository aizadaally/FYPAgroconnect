    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('CART', 'Cart'), ('ORDERED', 'Order Placed'), ('PAYMENT_CONFIRMED', 'Payment Confirmed'), ('PROCESSED', 'Processed'), ('DELIVERED', 'Delivered'), ('CANCELLED', 'Cancelled')], default='CART', max_length=20)),
